...
<body>
    <div class="container">
        ...
        <div class="menu clearfix">
            <p>TOM N TOMS MENU<img src="img/section_tit1.png" class="menu-title" /></p>
            <ul class="menu-banner autoplay-1">
                <li id="menu-item-1"><a href="#" class="menu-item-1">
                        <div class="overlay" id="overlay-1"></div>
                    </a><span>뱅쇼 2종(레드&화이트)</span></li>
                <li id="menu-item-2"><a href="#" class="menu-item-2">
                        <div class="overlay" id="overlay-2"></div>
                    </a><span>솔티 카라멜 레볼루션 3종</span></li>
                <li id="menu-item-3"><a href="#" class="menu-item-3">
                        <div class="overlay" id="overlay-3"></div>
                    </a><span>탐의보감 3종</span></li>
                <li id="menu-item-4"><a href="#" class="menu-item-4">
                        <div class="overlay" id="overlay-4"></div>
                    </a><span>고르곤졸라&디아블로 피자</span></li>
                <li id="menu-item-5"><a href="#" class="menu-item-5">
                        <div class="overlay" id="overlay-5"></div>
        ...
        <div class="intro clearfix">
            <div class="intro-background">
                <div class="intro-box">
                    <span class="intro-subtitle">대한민국 대표 스페셜티 커피 브랜드<br /></span>
                    <img src="img/tomntoms_tit_bold.svg" class="intro-title" /><br />
                    ...
                    <ul class="intro-list">
                        <li><a href="#" class="intro-item-1">가맹문의</a></li>
                        <li><a href="#" class="intro-item-2">브랜드 소개</a></li>
                        <li><a href="#" class="intro-item-3">신규매장 소개</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="mdspick clearfix">
            <p>TOM N TOMS MD's PICK<img src="img/section_tit2.png" class="mdspick-title" /></p>
            <ul class="mdspick-banner autoplay-2">
                <li><a href="#" class="mdspick-item-1">
                        <div class="overlay"></div>
                    </a><span>2021 플래너 with tenbyten</span></li>
                <li><a href="#" class="mdspick-item-2">
                        <div class="overlay"></div>
                    </a><span>와이드 텀블러 (500ml)</span></li>
                <li><a href="#" class="mdspick-item-3">
                        <div class="overlay"></div>
                    </a><span>허브티 3종 세트</span></li>
                <li><a href="#" class="mdspick-item-4">
                        <div class="overlay"></div>
                    </a><span>꼰대라떼 스틱</span></li>
                <li><a href="#" class="mdspick-item-5">
                        <div class="overlay"></div>
        ...
        <div class="sns clearfix">
            <p>TOM N TOMS SNS<img src="img/section_tit3.png" class="sns-title" /></p>
            <ul class="sns-gallery">
                <li><a href="#" class="sns-item-1">
...
<script type="text/javascript" src="js/main.js?time=<%=System.currentTimeMillis()%>"></script>
